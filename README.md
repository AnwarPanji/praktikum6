...
- Hasil dari Menambahkan Data + Lihat Data / Memasukkan Tambah (T)ambah lalu (L)ihat untuk menampilkan Data
![image](screenshot/tambah.png)

- Hasil dari Ubah Data / Memasukkan Ubah (U)bah 
![image](screenshot/ubah.png)

- Hasil dari Cari Data / Memasukkan Cari (C)ari
![image](screenshot/cari.png)

- Hasil dari Hapus Data + Lihat / Memasukkan Hapus (H)apus
![image](screenshot/hapus.png)
